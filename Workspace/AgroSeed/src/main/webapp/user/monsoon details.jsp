...
<form class="form-inline" action="" >
  ...
  <label for="type">Select the type of crop:</label>
...
<div class="a">
<a href ="../PDF/monsoon table-converted.pdf">Click her for the PDF of details of all the cropsaccording to monsoon.</a>
</div>
