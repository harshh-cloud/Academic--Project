...
<div class="jarallax about-banner" style="padding: 1em 0">
 ...
 <div class="contact" style="padding-bottom:2em">
				...
				<div class="contact-form-grid">
					<form action="" method="post">
	                   ...
	                   <div class="styled-input textarea-grid">
						...
						<div class="clearfix"> </div>
						<div class="styled-input textarea-grid">
							<textarea name="fertilizers" required></textarea>
						...
						<div class="clearfix"> </div>
						<div class="styled-input textarea-grid">
							<textarea name="water" required></textarea>
						...
						<div class="clearfix"> </div>
						<div class="styled-input textarea-grid">
							<textarea name="pesticides" required></textarea>
	   ...
	   // String password = request.getParameter("pass"); -->
		...
		st.executeUpdate("insert into crop(Crop,Description,Fertilizers,Water,Pesticides,TransDate,Status,TransUser) values('"+request.getParameter("name")+"','"+request.getParameter("description")+"','"+request.getParameter("fertilizers")+"','"+request.getParameter("water")+"','"+request.getParameter("pesticides")+"',CURDATE(),1,'Admin')");
		{
			out.println("success");
		}
