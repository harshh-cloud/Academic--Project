...
<div class="jarallax about-banner" style="padding: 1em 0">
			<div class="container">
				<div class="agileits-heading about-heading" >
					<p class="a">Add new Soil Details</p>
 ...
 <div class="contact" style="padding-bottom:2em">
				...
				<div class="contact-form-grid">
					<form action="" method="post">
	                   ...
	                   <div class="styled-input textarea-grid">
						...
						<div class="clearfix"> </div>
						<div class="styled-input textarea-grid">
							<textarea name="crops"  required><%= request.getParameter("sn3")%></textarea>
	   ...
	   // String password = request.getParameter("pass"); -->
		...
		st.executeUpdate("update soil set Description='"+request.getParameter("description")+"' ,Crops='"+request.getParameter("crops")+"' ,TransDate=CURDATE(), Status=1 ,TransUser='Admin' where Name='"+request.getParameter("name")+"' ");
		{
			out.println("success");
		}
