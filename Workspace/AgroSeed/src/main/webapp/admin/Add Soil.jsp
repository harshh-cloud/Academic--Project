...
<div class="jarallax about-banner" style="padding: 1em 0">
 ...
 <div class="contact" style="padding-bottom:2em">
	   ...
	   // String password = request.getParameter("pass"); -->
		...
		st.executeUpdate("insert into soil(Name,Description,Crops,TransDate,Status,TransUser) values('"+request.getParameter("name")+"','"+request.getParameter("description")+"','"+request.getParameter("crops")+"',CURDATE(),1,'Admin')");
		{
			out.println("success");
		}
