...
<form class="form-inline" action="" >
  ...
  <label for="type">Select the type of soil:</label>
...
<div>
  ...
  <%
 // Statement st= cn.createStatement();
   rs= st.executeQuery("select * from soil where Id='"+request.getParameter("type")+"' and Status="+1);
...
<a href ="../PDF/Soil table-converted (1).pdf">Click here for the PDF containing all the soils details along with monsoon crops.</a> 
</div>
