...
<div class="jarallax about-banner" style="padding: 1em 0">
 ...
 <div class="contact" style="padding-bottom:2em">
				...
				<div class="contact-form-grid">
					<form action="" method="post">
	                   ...
	                   <div class="styled-input textarea-grid">
						...
						<div class="clearfix"> </div>
						<div class="styled-input textarea-grid">
							<textarea name="sown" required><%= request.getParameter("sn3")%></textarea>
						...
						<div class="clearfix"> </div>
						<div class="styled-input textarea-grid">
							<textarea name="harvest" required><%= request.getParameter("sn4")%></textarea>
						...
						<div class="clearfix"> </div>
						<div class="styled-input textarea-grid">
							<textarea name="crops" required><%= request.getParameter("sn5")%></textarea>
	   ...
	   // String password = request.getParameter("pass"); -->
		...
		st.executeUpdate("update monsoon set Description='"+request.getParameter("description")+"' ,Sown='"+request.getParameter("sown")+"' ,Harvest='"+request.getParameter("harvest")+"' ,Crops='"+request.getParameter("crops")+"' ,TransDate=CURDATE(), Status=1 ,TransUser='Admin' where Type='"+request.getParameter("name")+"' ");
		{
			out.println("success");
		}
